({
    ...
    getClosestPoint: function (values, xValue) {
        ...
        xBisector = d3.bisector(function (d) { return d.x; }).left;
        ...
        function offset(neighboursForAbscissas) {
            ...
            for (abs in neighboursForAbscissas) {
                ...
                for (y in xNeighbours) {
                    ...
                    neighbours = neighbours.sort(function (a, b) { return a.y - b.y; });
                    if (n % 2 === 0) {
                        start = -(step / 2) * (n / 2);
                    }
                    else {
                    ...
                    neighbours.forEach(function (neighbour, i) { return neighbour.labelOffset = start + step * i; });
                }
            }
        }
