        ...
        getBestColumnWidth: (axes, dimensions, seriesData, options) => {
            var colData, delta:number, innerWidth, keys, nSeries:number, pseudoColumns, _ref;
            ...
            var columnsHGap:number = parseInt(options.columnsHGap);
            var total:number = (delta - columnsHGap) / nSeries;
            // Converting to int
            return total | 0;
        },
